...
//Blocks dazuwischen
 ...
 // var bgBlau = ctx.getImageData(51, 51, 1, 40);
  ...
  penguLinks.src ='images/pengu_nachRechts_Pink.png';
  penguRechts.src ='images/pengu_nachLinks_Gruen.png';
  ...
  if (key == 32) {
    ...
    if (ylinks <= 75 && xlinks >= 780 && xlinks <= 835) {
      ...
      setTimeout(function() {
        if ((functionBCompleted = true) && ylinks <= 190 && xlinks <= 100) {
          ctx.drawImage(kO, 50, 50, 850, 450);
          window.location.href="zweispielerEnde.html";
        }
        if ((functionBCompleted = true) && yrechts <= 190 && xrechts <= 100) {
          ctx.drawImage(kO, 50, 50, 850, 450);
          window.location.href="zweispielerEnde.html";
        } else {
        setTimeout(function() {
      ...
      setTimeout(function() {
        if ((functionBCompleted = true) && ylinks >= 110 && ylinks <= 290 && xlinks <= 100) {
          ctx.drawImage(kO, 50, 50, 850, 450);
          window.location.href="zweispielerEnde.html";
        }
        if ((functionBCompleted = true) && yrechts >= 110 && yrechts <= 290 && xrechts <= 100) {
          ctx.drawImage(kO, 50, 50, 850, 450);
          window.location.href="zweispielerEnde.html";
        } else {
        setTimeout(function() {
      ...
      setTimeout(function() {
        if ((functionBCompleted = true) && ylinks >= 210 && ylinks <= 390 && xlinks <= 100) {
          ctx.drawImage(kO, 50, 50, 850, 450);
          window.location.href="zweispielerEnde.html";
        }
        if ((functionBCompleted = true) && yrechts >= 210 && yrechts <= 390 && xrechts <= 100) {
          ctx.drawImage(kO, 50, 50, 850, 450);
          window.location.href="zweispielerEnde.html";
        } else {
        setTimeout(function() {
      ...
      setTimeout(function() {
        if ((functionBCompleted = true) && ylinks >= 310 && ylinks <= 490 && xlinks <= 100) {
          ctx.drawImage(kO, 50, 50, 850, 450);
          window.location.href="zweispielerEnde.html";
        }
        if ((functionBCompleted = true) && yrechts >= 310 && yrechts <= 490 && xrechts <= 100) {
          ctx.drawImage(kO, 50, 50, 850, 450);
          window.location.href="zweispielerEnde.html";
        } else {
        setTimeout(function() {
  ...
  setInterval (function() {
    ...
    if(key == 37) {
      ...
      if (xrechts == 150 && (yrechts >= 61 && yrechts <= 149)) {
        ...
        return;
        // 1.Reihe, 3.Eisblock nach links blocken
      } else if (xrechts == 350 && (yrechts >= 61 && yrechts <= 149)) {
        xrechts = 351;
        return;
        // 1.Reihe, 4.Eisblock nach links blocken
